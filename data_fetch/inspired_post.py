...
base_url = "https://api.socialverseapp.com/posts/inspire?page=1&page_size=1000&resonance_algorithm=resonance_algorithm_cjsvervb7dbhss8bdrj89s44jfjdbsjd0xnjkbvuire8zcjwerui3njfbvsujc5if"
...
if all_posts:
    ...
    df.to_csv("inspired_posts.csv", index=False)
    print("Data saved to 'inspired_posts.csv'.")
